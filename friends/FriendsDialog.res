"Friends/FriendsDialog.res" {
	...
	styles {
		...
		FriendsPanel {			
			bgcolor="none"
			render_bg {
				0="gradient(x0,y0+20,x1,y0+155, grey, darkGreyEnd)"
			}
		}	
 	...
 	layout
 	{
		...
		place { control="FriendPanelSelf,friends_search,FriendsDialogSheet" y=24 align=left margin-left=0 margin-right=0 margin-top=2 margin-bottom=0 width=max height=max dir=down spacing=3 }	
